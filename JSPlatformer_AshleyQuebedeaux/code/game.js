...
alert("Only a lantern full of kerosene can light the path and carry you home. Be warned, the will o\' wisps hypnotic dance has led many astray. Scavenge the supplies left by those who met their end here for your own lantern. You're not the first to wander into Lamplighter Cavern, and you will not be the last...");
...
/*
All background art used for this game can be found on OpenGameArt.org
Girl and Sprite Sheet for her found on HBBGames
*/
  ...
  for (var y = 0; y < this.height; y++) {
    ...
    for (var x = 0; x < this.width; x++) {
      ...
      if (Actor)
		...
		fieldType = "sideCornerA";
	  else if (ch == "n")
		fieldType = "sideBwall";
	  else if (ch == "b")
		fieldType = "sideA1wall";
	  else if (ch == "d")
		fieldType = "sideA2wall";
	  else if (ch == "h")
		fieldType = "sideCornerB";
	  else if (ch == "e")
...
var wobbleSpeed = 2, wobbleDist = 0.07;
  ...
  function startLevel(n) {
    ...
    runLevel(new Level(plans[n]), Display, function(status) {
      if (status == "lost")
        ...
        alert("You\'ve successfully navigated the Cavern!");
    });
  }
  startLevel(0);
}